...
import com.example.mynetflix.databinding.FragmentDetailBinding
...
import com.example.mynetflix.viewmodel.DetailViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            viewModel.detailMovie.observe(viewLifecycleOwner) { response ->
                ...
                movieSummaryInfoTxt.text = response.plot
                movieActorsInfoTxt.text = response.actors
                // Images adapter
            ...
            // Change fav icon color with click
